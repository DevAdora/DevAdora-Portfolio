  ...
  return (
    <main className="flex items-center justify-center text-center" id="home">
      <div className="w-full">
        ...
        <div className="flex justify-between items-center h-full w-full mb-[10%]">
          <div className="flex items-center justify-center gap-[10px] w-1/3">
            <div className="arrow">
            <Image
                width="64"
                height="64"
            ...
            <div className="w-4/5 text-left tracking-[1.4px] leading-[1.4]">
